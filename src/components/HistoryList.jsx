    ...
    <Box sx={{ mt: { xs: 3, sm: 5 } }}>
      ...
      >
        <Table size="small" sx={{ minWidth: { xs: 250, sm: 400 } }}>
          <TableHead>
            <TableRow sx={{ background: 'linear-gradient(135deg, rgba(255,240,248,0.9), rgba(245,243,255,0.9))' }}>
              <TableCell align="center" sx={{ fontWeight: 700, color: '#A21CAF', borderBottom: '2px solid rgba(236, 72, 153, 0.28)', fontSize: { xs: '0.75rem', sm: '0.875rem' }, padding: { xs: '8px 4px', sm: '16px' } }}>
                Period Date
              </TableCell>
              <TableCell align="center" sx={{ fontWeight: 700, color: '#A21CAF', borderBottom: '2px solid rgba(236, 72, 153, 0.28)', fontSize: { xs: '0.75rem', sm: '0.875rem' }, padding: { xs: '8px 4px', sm: '16px' } }}>
                Duration (Days)
              ...
              <TableCell align="center" sx={{ fontWeight: 700, color: '#A21CAF', borderBottom: '2px solid rgba(236, 72, 153, 0.28)', fontSize: { xs: '0.75rem', sm: '0.875rem' }, padding: { xs: '8px 4px', sm: '16px' }, width: 60 }}>
                Delete
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {records.map((rec) => (
              <TableRow key={rec.id} sx={{ '&:nth-of-type(odd)': { backgroundColor: 'rgba(255, 240, 248, 0.5)' }, '&:hover': { background: 'linear-gradient(135deg, rgba(251, 207, 232, 0.45), rgba(233, 213, 255, 0.4))', transition: 'all 0.2s ease' } }}>
                <TableCell align="center" sx={{ fontWeight: 600, fontSize: { xs: '0.7rem', sm: '0.875rem' }, padding: { xs: '6px 4px', sm: '16px' }, color: '#4C1D95' }}>
      ...
      <Dialog open={Boolean(deleteTarget)} onClose={() => setDeleteTarget(null)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ color: '#A21CAF', fontWeight: 700 }}>Are you sure you want to delete this entry?</DialogTitle>
        <DialogContent>
        ...
        <DialogActions sx={{ px: 3, pb: 2, justifyContent: 'space-between' }}>
          <Button
            ...
            color="inherit"
            variant="outlined"
            sx={{ borderColor: '#EC4899', color: '#A21CAF', borderRadius: 999 }}
          >
            No Cancel
          </Button>
          <Button
